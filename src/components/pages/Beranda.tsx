...
import data from "../data/dataBeranda";
    ...
    <>
      ...
      <div className="bg-grey p-[24px]">
        <Container className="bg-white">
          ...
          <Text
            size="lg"
            className="mx-auto mt-[45px] block max-w-[664.4px] text-center font-urbanist"
          >
        ...
        <div className="gap-x-[24px] sm:grid sm:grid-cols-2">
          {data.map(({ title, text, image, buttonText }) => {
            return (
